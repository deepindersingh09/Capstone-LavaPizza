  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const firestoreOrder = {
        ...
        // ✅ Use a clearer status set (your admin app can update this later)
        status: "RECEIVED",
        ...
        // Driver can be assigned later from admin app
      ...
      // ✅ Save last order id so Profile -> Track Order opens the real order
      await AsyncStorage.setItem("@last_order_id", docRef.id);
      ...
      Alert.alert(
        ...
        `Order #${docRef.id.slice(-6)}\n\nYour delicious pizza will arrive soon!\n\nTotal: $${total.toFixed(2)}`,
        [
          {
            text: "Track Order",
            onPress: () => router.replace(`/order_tracking/${docRef.id}` as any),
          },
          {
            text: "Home",
            style: "cancel",
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollView}>
        ...
        <View style={styles.section}>
          ...
          <TextInput
            ...
            placeholder="123 Main St, Apt 4B, City, Province, Postal Code"
            value={address}
        ...
        <View style={styles.section}>
          ...
          {paymentMethod === "card" && savedCards.length > 0 && (
            <View style={styles.savedCardsContainer}>
              ...
              <TouchableOpacity
                style={[styles.addNewCardButton, showNewCardInput && styles.savedCardSelected]}
