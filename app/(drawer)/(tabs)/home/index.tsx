...
const categories = [
  { id: 'c1', title: 'Pizza', img: require('../../../../assets/images/menu/pizza3.jpg'), routeId: 'pizza' },
  { id: 'c2', title: 'Gourmet Pizza', img: require('../../../../assets/images/menu/pizza2.png'), routeId: 'gourmet-pizza' },
  { id: 'c3', title: 'Pasta', img: require('../../../../assets/images/menu/pasta.png'), routeId: 'pasta' },
  { id: 'c4', title: 'Appetizers', img: require('../../../../assets/images/menu/appetizers.png'), routeId: 'appetizers' },
  { id: 'c5', title: 'Chicken Wings', img: require('../../../../assets/images/menu/chicken_wings.png'), routeId: 'chicken-wings' },
  { id: 'c6', title: 'Poutines', img: require('../../../../assets/images/menu/poutines.png'), routeId: 'poutines' },
  { id: 'c7', title: 'Shawarma & Donair', img: require('../../../../assets/images/menu/shawarma_wraps.png'), routeId: 'shawarma' },
  { id: 'c8', title: 'Subs & Sandwiches', img: require('../../../../assets/images/menu/pizza_subs.png'), routeId: 'subs' },
  { id: 'c9', title: 'Burgers', img: require('../../../../assets/images/menu/menu_pizza.png'), routeId: 'burgers' },
  { id: 'c10', title: 'Salads', img: require('../../../../assets/images/menu/salads.png'), routeId: 'salads' },
  { id: 'c11', title: 'Sides', img: require('../../../../assets/images/menu/sides.png'), routeId: 'sides' },
  { id: 'c12', title: 'Desserts', img: require('../../../../assets/images/menu/cakes.png'), routeId: 'desserts' },
  { id: 'c13', title: 'Drinks & Dips', img: require('../../../../assets/images/menu/drinks.png'), routeId: 'drinks' },
  { id: 'c14', title: 'Special Deals', img: require('../../../../assets/images/menu/double_pizza.png'), routeId: 'deals' },
];
...
export default function HomeScreen() {
  ...
  const loadDeals = () => {
    ...
    if (dealsData.length === 0) {
      setDeals([
        { id: 'deal1', title: 'Family Meal Deal', price: 49.99, img: require('../../../../assets/images/menu/menu_pizza.png') },
        { id: 'deal2', title: '2 Large Pizzas', price: 36.99, img: require('../../../../assets/images/menu/menu_pizza.png') },
        { id: 'deal3', title: 'Party Pack', price: 69.99, img: require('../../../../assets/images/menu/menu_pizza.png') },
        { id: 'deal4', title: 'Pizza & Wings Combo', price: 34.99, img: require('../../../../assets/images/menu/menu_pizza.png') },
      ]);
    } else {
      setDeals(dealsData);
    }
