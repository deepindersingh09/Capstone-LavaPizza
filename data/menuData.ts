...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    id: 'supreme-pizza',
    name: 'Supreme Pizza',
    description: 'Pepperoni, ham, mushrooms, green peppers, onions, Italian sausage',
    sizes: [
      { size: 'Small 10"', price: 14.99 },
      { size: 'Medium 12"', price: 18.99 },
      { size: 'Large 14"', price: 22.99 },
  ...
  },
  {
    ...
    description: 'Butter chicken sauce, marinated chicken, onions, green peppers, cilantro',
    sizes: [
      { size: 'Small 10"', price: 14.99 },
      { size: 'Medium 12"', price: 18.99 },
      { size: 'Large 14"', price: 22.99 },
  ...
  },
  {
    ...
    description: 'Tandoori sauce, marinated chicken, onions, green peppers, cilantro',
    sizes: [
      { size: 'Small 10"', price: 14.99 },
      { size: 'Medium 12"', price: 18.99 },
      { size: 'Large 14"', price: 22.99 },
  ...
  },
  {
    ...
    description: 'Achari sauce, marinated chicken, onions, green peppers, mixed pickles',
    sizes: [
      { size: 'Small 10"', price: 14.99 },
      { size: 'Medium 12"', price: 18.99 },
      { size: 'Large 14"', price: 22.99 },
  ...
  },
  {
    ...
    description: 'Pesto sauce, grilled chicken, sun-dried tomatoes, artichokes, feta',
    sizes: [
      { size: 'Small 10"', price: 14.99 },
      { size: 'Medium 12"', price: 18.99 },
      { size: 'Large 14"', price: 22.99 },
  ...
  },
  {
    ...
    description: 'Mushrooms, green peppers, onions, tomatoes, black olives, artichokes, spinach',
    sizes: [
      { size: 'Small 10"', price: 13.99 },
      { size: 'Medium 12"', price: 17.99 },
      { size: 'Large 14"', price: 21.99 },
  ...
  },
  {
    ...
    description: 'Layers of pasta with vegetables, marinara, ricotta, and mozzarella',
    price: 14.99,
    category: 'pasta',
  },
  {
  ...
  },
  {
    id: 'loaded-nachos',
    name: 'Loaded Nachos',
    description: 'Nachos with cheese, ground beef, jalapeños, sour cream, guacamole',
    price: 12.99,
    category: 'appetizers',
  },
  {
  ...
  // ========== CHICKEN WINGS ==========
  {
    ...
    description: 'Choice of: Hot, Medium, Mild, Honey Garlic, BBQ, Teriyaki, Salt & Pepper, Lemon Pepper, Cajun, Sweet Chili',
    price: 12.99,
  ...
  // ========== SHAWARMA & DONAIR ==========
  {
    ...
    description: 'Marinated chicken with garlic sauce, lettuce, tomatoes, pickles, turnips',
    price: 10.99,
    category: 'shawarma',
    popular: true,
  },
  {
    ...
    description: 'Marinated beef with tahini sauce, lettuce, tomatoes, onions, parsley',
    price: 11.99,
    category: 'shawarma',
  },
  {
  ...
  },
  {
    id: 'falafel-wrap',
    name: 'Falafel Wrap',
    description: 'Crispy falafel with tahini sauce, lettuce, tomatoes, pickles, turnips',
    price: 9.99,
    category: 'shawarma',
  },
  {
  ...
  },
  {
    ...
    description: 'Chicken shawarma with rice, salad, hummus, garlic sauce, and pita',
    price: 15.99,
    category: 'shawarma',
  },
  {
    ...
    description: 'Beef shawarma with rice, salad, hummus, tahini sauce, and pita',
    price: 16.99,
    category: 'shawarma',
  },
  {
    ...
    description: 'Chicken and beef shawarma with rice, salad, hummus, sauces, and pita',
    price: 17.99,
    category: 'shawarma',
  },
  {
  ...
  },
  {
    id: 'italian-sub',
    name: 'Italian Sub',
    description: 'Ham, salami, pepperoni, cheese, lettuce, tomatoes, Italian dressing',
    price: 11.99,
    category: 'subs',
  },
  {
  ...
  // ========== BURGERS ==========
  {
    id: 'classic-burger',
    name: 'Classic Burger',
    description: 'Beef patty, lettuce, tomatoes, onions, pickles, ketchup, mustard',
    price: 9.99,
    category: 'burgers',
  },
  {
  ...
  // ========== SALADS ==========
  {
    id: 'garden-salad',
    name: 'Garden Salad',
    description: 'Mixed greens, tomatoes, cucumbers, onions, carrots, choice of dressing',
    price: 9.99,
    category: 'salads',
  },
  {
  ...
  },
  {
    id: 'greek-salad',
    name: 'Greek Salad',
    description: 'Lettuce, tomatoes, cucumbers, red onions, black olives, feta cheese, Greek dressing',
    price: 10.99,
    category: 'salads',
  },
  {
  ...
  },
  {
    id: 'taco-salad',
    name: 'Taco Salad',
    description: 'Lettuce, ground beef, cheese, tomatoes, onions, tortilla chips, salsa, sour cream',
    price: 12.99,
    category: 'salads',
  },
  ...
  },
  {
    ...
    description: '4 large pizzas, 3 lbs wings, 2 garlic breads with cheese, 2x 2L pop',
    price: 89.99,
    category: 'deals',
  },
  {
...
export const getItemPrice = (item: MenuItem, size?: string): number => {
  if (item.sizes && size) {
